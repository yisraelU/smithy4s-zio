...
object Dependencies {
  object Http4s {
    val http4sVersion = Def.setting("0.23.30")
  ...
  object ZIO {
    ...
    val prelude = "dev.zio" %% "zio-prelude" % "1.0.0-RC35"
    val schema = "dev.zio" %% "zio-schema" % "1.5.0"
    val catsInterop = "dev.zio" %% "zio-interop-cats" % "23.1.0.4"
